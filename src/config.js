...
const namePrefix = "Owlander";
const description = "Owlander NFT";
...
const extraMetadata = {
  external_url: "https://owlander.io", // Replace with your website or remove this line if you do not have one.
};
